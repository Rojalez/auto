    ...
    <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-x-auto shadow-xl sm:rounded-lg px-4 py-4">
                    ...
                    <button @click="openModal()" class="bg-yellow-400 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded-lg my-3">Добавить</button>
                    ...
                    <div class='overflow-x-auto rounded-xl'>
                        ...
                        <thead>
                            <tr class="bg-gray-700 text-white border">
                                ...
                                <th class="border px-4 py-2">Скидка</th>
                          ...
                          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="">
                                  ...
                                  <div class="mb-4">
                                      ...
                                      <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput1" placeholder="Название" v-model="form.name">
                                  </div>
                                  <div class="mb-4">
                                      <label for="exampleFormControlInput1" class="block text-gray-700 text-sm font-bold mb-2">Скидка:</label>
                                      <input type="number" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput1" placeholder="Размер скидки" v-model="form.procent">
                                  </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            save: function (data) {
                this.$inertia.post('/dashboard/skidki', data)
                this.reset();
                this.closeModal();
                this.editMode = false;
            },
            ...
            update: function (data) {
                data._method = 'PUT';
                this.$inertia.post('/dashboard/skidki/' + data.id, data)
                this.reset();
                this.closeModal();
            },
